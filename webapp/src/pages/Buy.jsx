        ...
        <>
          <div className="card">
            <div className="quote-box">
              ...
              <div className="quote-row">
                <span>مبلغ پایه</span>
                <span className="value">{quote.base_afn.toLocaleString()} افغانی</span>
              </div>
              <div className="quote-row">
                <span>کارمزد ({quote.fee_percent}٪)</span>
                <span className="value">{quote.fee_afn.toLocaleString()} افغانی</span>
              </div>
      ...
      {step === "receipt" && (
        <div className="card">
          <div className="info-box" style={{ marginBottom: 16 }}>
            <div className="row">
              <span>بانک</span>
              <span className="value">عزیز بانک (Azizi Bank)</span>
            </div>
            <div className="row">
              <span>صاحب حساب</span>
              <span className="value">SAJAD ALI MOHAMMADI</span>
            </div>
            <div className="row">
              <span>شماره حساب</span>
              <span className="value">000601102302066</span>
            </div>
          </div>
          ...
          <label className={`upload-box ${receiptUrl ? "has-file" : ""}`}>
            ...
            {receiptUploading ? "در حال آپلود..." : receiptUrl ? "✅ رسید بارگذاری شد" : "📎 انتخاب تصویر رسید"}
          </label>
          <button
      ...
      {step === "wallet" && (
        <div className="card">
          ...
          <div className="notice warn" style={{ marginBottom: 14 }}>
            ⚠️ لطفاً آدرس و شبکه را با دقت بررسی کنید؛ ارسال به آدرس یا شبکهٔ اشتباه ممکن است
            باعث از دست رفتن دارایی شود.
          </div>
          <button className="btn btn-primary" onClick={() => setStepIdx(6)} disabled={!walletAddress.trim()}>
            ادامه
          </button>
        </div>
      )}
      ...
      {step === "done" && (
        <div className="card success-screen">
          ...
          <div className="notice">
            تتر شما پس از تأیید پرداخت توسط تیم ما، ظرف کمتر از ۱ ساعت به آدرس اعلام‌شده واریز
            خواهد شد.
            <br />
            🆘 پشتیبانی: @SJDPLUS
          </div>
