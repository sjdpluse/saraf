...
DEFAULT_SPREADS: dict[str, float] = {
    ...
    "chf": 1.2,
    "sek": 1.8,
    # طلا — کلیدها به شکل gold24 / gold22 / gold21 / gold18 / gold14
    # (فقط برای عیارهایی استفاده می‌شود که منبع محلی نرخ خرید/فروش را
    # جداگانه منتشر نمی‌کند؛ یعنی نرخ رسمی تک‌عددی کابل)
    "gold24": 1.0,
    "gold22": 1.0,
    "gold21": 1.0,
    "gold18": 1.2,
