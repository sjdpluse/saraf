...
OPENROUTER_SYSTEM_PROMPT = os.getenv(
    ...
    (
        ...
        "قوانین: ۱) هرگز هیچ نرخ، قیمت یا عدد مالی مشخصی از خودتان تولید نکنید. "
        "۲) پاسخ حداکثر یک یا دو جمله باشد. "
        "۳) لحن انسانی، حرفه‌یی و دوستانه باشد. "
        "۴) لازم نیست در تمام پاسخ‌ها لینک ربات را بنویسید. "
        "۵) اگر کامنت فقط تشکر یا تعریف بود، کوتاه تشکر کنید. "
        "۶) اگر کامنت نامرتبط یا توهین‌آمیز بود، محترمانه و کوتاه پاسخ دهید."
    ),
)
...
IN_PERSON_MAP_URL = "https://maps.app.goo.gl/9oJXYnfyJ8QvAGvXA?g_st=atm"
