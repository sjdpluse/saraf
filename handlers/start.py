...
WELCOME_TEXT = (
    "سلام {name} 👋\n\n"
    "به ربات رسمی *Safari.af* خوش آمدید.\n\n"
    "در این ربات می‌توانید نرخ لحظه‌ای ارزها و قیمت طلا را با دقت و سرعت بالا مشاهده کنید.\n\n"
    "امکانات ربات:\n"
    "💵 نرخ لحظه‌ای دالر، یورو، درهم، تومان، ریال، کلدار، پوند و سایر ارزها\n"
    "🥇 قیمت روز طلا در عیارهای مختلف\n"
    "📊 نمایش تغییرات و روند قیمت‌ها\n"
    "⚡ بروزرسانی خودکار اطلاعات در طول شبانه‌روز\n\n"
...
ABOUT_TEXT = (
    ...
    "Sarafi.af با هدف فراهم‌سازی دسترسی سریع، دقیق و رایگان به اطلاعات بازار مالی افغانستان توسعه یافته است تا کاربران، تاجران، صرافان، سرمایه‌گذاران و عموم مردم بتوانند در هر زمان به جدیدترین نرخ‌های ارز و طلا دسترسی داشته باشند.\n\n"
    "✨ امکانات:\n"
    ...
    "*Sajad Mohammadi*\n"
    "Telegram: @SJDPLUS\n\n"
    "از پیشنهادها، انتقادها و گزارش خطاهای شما برای بهبود مستمر Sarafi.af استقبال می‌کنیم.\n\n"
    ...
    "© 2026 Sarafi.af — Smart Exchange Rates & Gold Price bot"
)
